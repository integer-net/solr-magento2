 ...
 */
class Integer\Net\Solr\Test\Model\Bridge\AttributeRepository extends Ecom\Dev\PHPUnit\Test\CaseTest
{
    /**
     * @test
    ...
    {
        $attributeRepository = $this->_bridgeAttributerepositoryFactory->create();
