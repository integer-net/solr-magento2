 ...
 * @loadFixture config
 */
class Integer\Net\Solr\Test\Model\ProductIterator extends Ecom\Dev\PHPUnit\Test\CaseTest\Controller
{
    /**
     * @test
     * @loadFixture catalog
    ...
    public function shouldLazyloadCollections($idFilter, $pageSize, $expectedProductIds)
    {
        ...
        $iterator = new Integer\Net\Solr\Model\Bridge\LazyProductIterator(1, $idFilter, $pageSize);
        $actualProductIds = [];
        $guard = 0;
