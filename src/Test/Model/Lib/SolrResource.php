 ...
 */
class Integer\Net\Solr\Test\Model\Lib\SolrResource extends PH\PUnit\Framework\TestCase
{
    /**
     * @param array $config
     * @test
    ...
    public function coresShouldBeSwappedBasedOnConfig(array $config, array $expectation)
    {
        ...
        foreach ($expectation as $storeId => $arguments) {
            ...
            call_user_func_arrayfunc([$_mocker, 'with'], $arguments);
    ...
    {
        $defaultGeneralConfig = Integer\Net\Solr\Config\General\Builder::defaultConfig();
        $swapCoreServerConfig = Integer\Net\Solr\Config\Server\Builder::swapCoreConfig();
        $swapCoreIndexingConfig = Integer\Net\Solr\Config\Indexing\Builder::swapCoreConfig();
        $allData = [
            'singlestore' => [
                'config' => [0 => [
                ...
                'expectation' => [0 => [Integer\Net\Solr\Config\Server\Builder::DEFAULT_CORE, Integer\Net\Solr\Config\Server\Builder::SWAP_CORE]]
            ],
            'stores-with-same-config' => [
                ...
                'expectation' => [1 => [Integer\Net\Solr\Config\Server\Builder::DEFAULT_CORE, Integer\Net\Solr\Config\Server\Builder::SWAP_CORE]]
            ],
            'stores-with-different-config' => [
                ...
                'expectation' => [
                    0 => [Integer\Net\Solr\Config\Server\Builder::DEFAULT_CORE, Integer\Net\Solr\Config\Server\Builder::SWAP_CORE],
                    1 => ['core2', 'core3']
                ]
            ]
        ];
...
class Integer\Net\Solr\Config\General\Builder
{
    /*
     * Default values
     */
     ...
     * @return Integer\Net\Solr\Config\General\Builder
     */
 ...
 */
class Integer\Net\Solr\Config\Server\Builder
{
    /*
     * Default values
     */
 ...
 * @internal test builder
 */
class Integer\Net\Solr\Config\Indexing\Builder
{
    /*
     * Default values
     */
    ...
    /**
     * @param int $pagesize
     * @return Integer\Net\Solr\Config\Indexing\Builder
     */
