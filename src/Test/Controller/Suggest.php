 ...
 * @loadFixture config
 */
class Integer\Net\Solr\Test\Controller\Suggest extends Integer\Net\Solr\Controller\Test\Controller\AbstractController\AbstractAbstract
{

    protected function setUp()
    {
        parent::setUp();
        $this->_modelIndexerFactory->create()->reindexAll();
    }
    ...
    public function shouldShowAutosuggestBox()
    {
        ...
        $this->_frameworkRegistry->unregister('_singleton/eav/config');
    ...
    public function shouldShowAutosuggestBoxLocalized()
    {
        ...
        $this->assertEquals(2, $this->_modelStoreManagerInterface->getStore()->getId());
        $this->assertResponseBodyContains('<ul class="searchwords">', 'Search term suggest container');
