...
class Integer\Net\Solr\Model\Bridge\PageRepository implements PageRepository
{
    /**
     * @var int
     */
    ...
    {
        return new Integer\Net\Solr\Model\Bridge\LazyPageIterator($storeId, $pageIds, $this->_pageSize);
    }
}