 ...
 */
final class Integer\Net\Solr\Model\Config\Store implements Config
{
    /**
     * @var int
     */
     ...
     * @param int $_storeId
     */
    public function __construct($_storeId, \Magento\Store\Model\StoreManagerInterface $modelStoreManagerInterface, 
    ...
    {
        return new StoreConfig($this->_modelStoreManagerInterface->getStore($this->_storeId)->getBaseUrl(), $this->_frameworkFilesystem->getDirectoryWrite('log')->getAbsolutePath());
    }
    ...
    {
        return $this->_configScopeConfigInterface->getValue($path, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_storeId);
    }

    protected function _getConfigFlag($path)
    {
        return $this->_configScopeConfigInterface->isSetFlag($path, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_storeId);
    }
