...
class CatalogSearchFulltextCollection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    /**
     * @var  QueryResponse
     * @deprecated
     ...
     *
     * Includes Bugfix for Magento 2.1 and condition type "in", visibility filter is excluded
     *
     * @param string $field
